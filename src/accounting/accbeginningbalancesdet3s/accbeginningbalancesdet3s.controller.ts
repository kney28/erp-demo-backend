...
@Controller('accounting/accbeginningbalancesdet3s')
@UseInterceptors(ClassSerializerInterceptor)
@UseGuards(JwtAuthGuard)
export class Accbeginningbalancesdet3sController {
  constructor(
    private readonly accbeginningbalancesdet3sService: Accbeginningbalancesdet3sService,
  ) {}

  @Post()
  create(
    @Body()
    createAccbeginningbalancesdet3Dto: CreateAccbeginningbalancesdet3Dto,
  ): Promise<Accbeginningbalancesdet3> {
    return this.accbeginningbalancesdet3sService.create(
      createAccbeginningbalancesdet3Dto,
    );
  }
  ...
  update(
    ...
    return this.accbeginningbalancesdet3sService.update(
      id,
